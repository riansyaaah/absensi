...
class FaceNetService {
  ...
  List get predictedDataList => this._predictedData!;
  ...
  setCurrentPrediction(CameraImage cameraImage, Face face) {
    ...
    print(json.encode(this._predictedData));
  }

  /// takes the predicted data previously saved and do inference
  String? predict(List<dynamic> datas) {
    /// search closer user prediction if exists
    return _searchResult(this._predictedData!, datas);
  }
  ...
  String _searchResult(List predictedData, List<dynamic> datas) {
    String predRes = "";
    ...
    currDist = _euclideanDistance(datas, predictedData);
